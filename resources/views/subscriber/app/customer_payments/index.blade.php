...
@section('title', 'دفعات العملاء (سندات القبض)')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">دفعات العملاء (سندات القبض)</h4>
    <a href="{{ route('subscriber.app.customer-payments.create') }}" class="btn btn-primary">
        <iconify-icon icon="solar:add-circle-bold" class="me-1"></iconify-icon> تسجيل دفعة جديدة
    </a>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <iconify-icon icon="solar:user-bold" class="text-muted me-2"></iconify-icon>
                        ...
                        <td class="text-end pe-4">
                            <a href="{{ route('subscriber.app.customer-payments.show', $payment) }}" class="btn btn-sm btn-soft-primary">
