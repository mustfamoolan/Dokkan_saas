    ...
    <div class="col-md-7">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0">تسجيل دفعة عميل (سند قبض)</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('subscriber.app.customer-payments.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary px-4">حفظ السند وتأكيد الدفعة</button>
                        <a href="{{ route('subscriber.app.customer-payments.index') }}" class="btn btn-light px-4">إلغاء</a>
                    </div>
                </form>
            </div>
        </div>
