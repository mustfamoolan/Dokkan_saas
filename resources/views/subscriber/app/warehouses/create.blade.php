    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">بيانات المستودع الجديد</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('subscriber.app.warehouses.store') }}" method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary px-4">حفظ المستودع</button>
