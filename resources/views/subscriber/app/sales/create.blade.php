...
<form action="{{ route('subscriber.app.sales.store') }}" method="POST" id="salesForm">
    @csrf
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">تفاصيل فاتورة البيع</h4>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-4">
                        ...
                        <table class="table table-bordered" id="itemsTable">
                            ...
                            <tbody>
                                <tr class="item-row">
                                    ...
                                    <td>
                                        <input type="number" name="items[0][quantity]" class="form-control qty-input" step="0.01" min="0.01" required value="1">
                                    </td>
                                    <td>
                                        <input type="number" name="items[0][unit_price]" class="form-control price-input" step="0.01" min="0" required value="0">
                                    </td>
                                    <td class="line-total text-center align-middle fw-bold">0.00</td>
                                    <td>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="discount_amount" id="discountInput" class="form-control" step="0.01" min="0" value="0">
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between h4 mb-4">
                        <span>الصافي:</span>
                        <span id="totalDisplay" class="text-primary fw-bold">0.00</span>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary w-100 py-2 mb-2">حفظ فاتورة البيع</button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addButton.addEventListener('click', function() {
        ...
        newRow.querySelector('select').name = newRow.querySelector('select').name.replace('[0]', '[' + rowCount + ']');
