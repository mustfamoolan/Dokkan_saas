...
@section('content')
<form action="{{ route('subscriber.app.purchases.store') }}" method="POST" id="purchaseForm">
    @csrf
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                        ...
                        <table class="table table-bordered" id="itemsTable">
                            ...
                            <tbody>
                                <tr class="item-row">
                                    ...
                                    <td>
                                        <input type="number" name="items[0][unit_cost]" class="form-control cost-input" step="0.01" min="0" required value="0">
                                    </td>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-primary w-100 py-2 mb-2">حفظ الفاتورة</button>
