...
<div class="d-flex justify-content-between align-items-center mb-4 d-print-none">
    <h4 class="mb-0">كشف حساب عميل</h4>
    <div>
        <a href="{{ route('subscriber.app.print.customer-statement', $customer) }}" target="_blank" class="btn btn-soft-secondary me-2">
            <iconify-icon icon="solar:printer-bold" class="me-1"></iconify-icon> طباعة الكشف
        </a>
        <a href="{{ route('subscriber.app.customers.index') }}" class="btn btn-light">
            <iconify-icon icon="solar:arrow-right-linear" class="me-1"></iconify-icon> عودة للعملاء
        </a>
    </div>
</div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="d-flex align-items-center mb-2">
                    <div class="bg-soft-primary text-primary p-3 rounded-circle me-3">
                        <iconify-icon icon="solar:user-bold" class="h3 mb-0"></iconify-icon>
                    </div>
                    <div>
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <div class="bg-light p-3 rounded d-inline-block text-start" style="min-width: 250px;">
                    <div class="text-muted small mb-1">الرصيد الحالي المستحق</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pe-4 text-end fw-bold">
                            <span class="{{ $trx['balance'] >= 0 ? 'text-danger' : 'text-success' }}">
                                {{ number_format(abs($trx['balance']), 2) }}
                                <small>{{ $trx['balance'] >= 0 ? 'مدين' : 'دائن' }}</small>
                            </span>
                        </td>
                    </tr>
                    @endforeach
                ...
                <tfoot class="bg-light fw-bold">
                    <tr>
                        ...
                        <td class="pe-4 text-end text-{{ $balanceInfo['color'] }}">
                            ...
                            <small>{{ $balanceInfo['type'] === 'debit' ? 'مدين' : 'دائن' }}</small>
                        </td>
                    </tr>
                </tfoot>
            </table>
